...
public class NewProxyServer implements ServerSapListener, ConnectionEventListener, PowerProxyServer, SecurityEventListener {
    private static int connectionIdCounter = 1;
    public static boolean LOCAL_API_MODE = false;
    protected static NewProxyServer instance;
...
//  private SecurityHandler securityHandler;
    ...
    protected NewProxyServer() {
        init();
    }

    protected NewProxyServer(Connection connection, int connectionId) {
        init();
...
//      JavawsConsoleController.getInstance().showConsoleIfEnabled();
    ...
    public static NewProxyServer getInstance() {
        if (instance == null) {
            instance = new NewProxyServer();
        }
        return instance;
    }
    ...
    public void connectionIndication(Connection connection) {
        ...
        try {
            connection.waitForStartDT(new NewProxyServer(connection, myConnectionId), 5000);
        } catch (IOException e) {
