 ...
 */
public class PWV18_TimeDelayAnalysis {
    ...
    public static double DelaySelectThreshold = -1;
...
//        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.600, 0.02, 0, 100, 0.700, RandomGenerator.LINEAR, 10.00*0.700/100.00));
//        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.600, 0.02, 0, 100, 0.700, RandomGenerator.LINEAR, 25.00*0.700/100.00));
//        configurations.add(new Configuration(FULL_BREAKER_OPEN, 0.600, 0.02, 0, 100, 0.700, RandomGenerator.LINEAR, 50.00*0.700/100.00));
        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.600, 0.02, 0, 100, 0.700, RandomGenerator.LINEAR, 50.00*0.700/100.00));
        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.600, 0.02, 0, 100, 0.700, RandomGenerator.LINEAR, 75.00*0.700/100.00));

        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.01, 0.02, 0, 100, 0.04, RandomGenerator.LINEAR, 10.00*0.04/100.00));
        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.01, 0.02, 0, 100, 0.04, RandomGenerator.LINEAR, 25.00*0.04/100.00));
        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.01, 0.02, 0, 100, 0.04, RandomGenerator.LINEAR, 50.00*0.04/100.00));
        configurations.add(new Configuration(FULL_BREAKER_OPEN_DELAY_MITIGATION, 0.01, 0.02, 0, 100, 0.04, RandomGenerator.LINEAR, 75.00*0.04/100.00));


        String path = "C:\\EMA\\Experiments\\30-04-2016\\";
        for (Configuration configuration : configurations) {
            ...
            DelaySelectThreshold = configuration.getDelaySelectThreshold();
