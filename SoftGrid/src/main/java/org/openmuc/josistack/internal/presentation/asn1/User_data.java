...
public final class User_data {
	...
	public int encode(BerByteArrayOutputStream berOStream, boolean explicit) throws IOException {
		...
		if (fully_encoded_data != null) {
			...
			codeLength += (new BerIdentifier(BerIdentifier.APPLICATION_CLASS, BerIdentifier.CONSTRUCTED, 1))
					.encode(berOStream);
			return codeLength;
		...
		if (simply_encoded_data != null) {
			...
			codeLength += (new BerIdentifier(BerIdentifier.APPLICATION_CLASS, BerIdentifier.PRIMITIVE, 0))
					.encode(berOStream);
			return codeLength;
