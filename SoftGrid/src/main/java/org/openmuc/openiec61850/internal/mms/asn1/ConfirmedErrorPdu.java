...
public final class ConfirmedErrorPdu {
	...
	public BerInteger modifierPosition = null;

	public ServiceError serviceError = null;
	...
	public ConfirmedErrorPdu(BerInteger invokeID, BerInteger modifierPosition, ServiceError serviceError) {
		id = identifier;
	...
	public int decode(InputStream iStream, boolean explicit) throws IOException {
		...
		if (subCodeLength < length.val) {
			...
			if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 1)) {
				modifierPosition = new BerInteger();
				subCodeLength += modifierPosition.decode(iStream, false);
				decodedIdentifier = false;
			}
		}
		if (subCodeLength < length.val) {
			...
			if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 2)) {
				...
				subCodeLength += serviceError.decode(iStream, false);
				decodedIdentifier = false;
			}
			else {
				throw new IOException("Identifier does not macht required sequence element identifer.");
