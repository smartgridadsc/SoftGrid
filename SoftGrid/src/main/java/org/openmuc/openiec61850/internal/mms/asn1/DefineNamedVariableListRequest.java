...
public final class DefineNamedVariableListRequest {
	...
	public DefineNamedVariableListRequest(ObjectName variableListName, SubSeqOf_listOfVariable listOfVariable) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream berOStream, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength += variableListName.encode(berOStream, true);
	...
	public int decode(InputStream iStream, boolean explicit) throws IOException {
		...
		if (subCodeLength < length.val) {
			...
			choiceDecodeLength = variableListName.decode(iStream, berIdentifier);
