...
/**
 * The listener sc for receiving incoming ASDUs and connection closed events. The class that is interested in
 * incoming ASDUs implements this sc. The object of that class is registered as a listener through the
