...
public class InformationObject {
    ...
    InformationObject(DataInputStream is, TypeId typeId, int numberOfSequenceElements, ConnectionSettings settings)
        ...
        switch (typeId) {
            ...
            // 6
            case M_ST_TA_1:
                informationElements = new InformationElement[][]{{new IeValueWithTransientState(is), new IeQuality(is),
                        new IeTime24(is)}};
                break;
            // 7
            case M_BO_NA_1:
            ...
            // 8
            case M_BO_TA_1:
                informationElements = new InformationElement[][]{{new IeBinaryStateInformation(is), new IeQuality(is),
                        new IeTime24(is)}};
                break;
            // 9
            case M_ME_NA_1:
            ...
            // 10
            case M_ME_TA_1:
                informationElements = new InformationElement[][]{{new IeNormalizedValue(is), new IeQuality(is),
                        new IeTime24(is)}};
                break;
            // 11
            case M_ME_NB_1:
            ...
            // 12
            case M_ME_TB_1:
                informationElements = new InformationElement[][]{{new IeScaledValue(is), new IeQuality(is),
                        new IeTime24(is)}};
                break;
            // 13
            case M_ME_NC_1:
            ...
            // 14
            case M_ME_TC_1:
                informationElements = new InformationElement[][]{{new IeShortFloat(is), new IeQuality(is),
                        new IeTime24(is)}};
                break;
            // 15
            case M_IT_NA_1:
            ...
            // 17
            case M_EP_TA_1:
                informationElements = new InformationElement[][]{{new IeSingleProtectionEvent(is), new IeTime16(is),
                        new IeTime24(is)}};
                break;
            // 18
            case M_EP_TB_1:
            ...
            case C_SE_TA_1:
                informationElements = new InformationElement[][]{{new IeNormalizedValue(is),
                        new IeQualifierOfSetPointCommand(is), new IeTime56(is)}};
                break;
            // 62
            case C_SE_TB_1:
                informationElements = new InformationElement[][]{{new IeScaledValue(is),
            ...
            case P_ME_NA_1:
                informationElements = new InformationElement[][]{{new IeNormalizedValue(is),
                        new IeQualifierOfParameterOfMeasuredValues(is)}};
                break;
            // 111
            case P_ME_NB_1:
                informationElements = new InformationElement[][]{{new IeScaledValue(is),
            ...
            // 120
            case F_FR_NA_1:
                informationElements = new InformationElement[][]{{new IeNameOfFile(is), new IeLengthOfFileOrSection(is),
            ...
            // 127
            case F_SC_NB_1:
                informationElements = new InformationElement[][]{{new IeNameOfFile(is), new IeTime56(is),
                        new IeTime56(is)}};
                break;
            default:
                throw new IOException("Unable to parse Information Object because of unknown Type Identification: "
                        + typeId);
        }
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            ...
            boolean match = true;
            if (obj instanceof InformationObject && informationElements != null && informationElements.length > 0) {
                InformationObject informationObject = (InformationObject) obj;
                for(int i = 0; i < informationElements.length; i++)
                {
                    for (int j = 0 ; j < informationElements[i].length ; j++) {
                        match = match && informationElements[i][j].toString().equals(informationObject.getInformationElements()[i][j].toString());
                        if(!match)
                        {
                            return false;
                        }
